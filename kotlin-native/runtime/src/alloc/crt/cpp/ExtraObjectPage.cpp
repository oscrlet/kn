...
void ExtraObjectPage::ReusePages(uint32_t blockSize) noexcept {
    CustomAllocInfo("ExtraObjectPage::ReusePages()");
    ...
    Reuse(this, ExtraObjectPage::SIZE);
}

void ExtraObjectPage::RecyclePages() noexcept {
    CustomAllocInfo("RecyclePages::ReusePages()");
    Recycle(this, ExtraObjectPage::SIZE);
}
