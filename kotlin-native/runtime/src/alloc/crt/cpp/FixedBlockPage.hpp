...
public:
    static inline constexpr const size_t SIZE = 16 * KiB;

    static inline constexpr const int MAX_BLOCK_SIZE = 64;
    ...
    void ReusePages(uint32_t blockSize) noexcept;

    void RecyclePages() noexcept;
