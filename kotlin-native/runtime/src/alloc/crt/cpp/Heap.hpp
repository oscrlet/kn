...
private:
    PageStore<FixedBlockPage, true> fixedBlockPages_[FixedBlockPage::MAX_BLOCK_SIZE + 1];
    PageStore<NextFitPage, true> nextFitPages_;
    PageStore<SingleObjectPage, false> singleObjectPages_;
    PageStore<ExtraObjectPage, true> extraObjectPages_;
